...
- Current releases:
  - `downloads/ExcelsisHelper-1.3.1-public.1-Setup.exe`
  - `downloads/ExcelsisHelper-1.3.1-public.1-source.zip`
...
- `downloads/ExcelsisHelper-1.3.1-public.1-Setup.exe` - sanitized public Helper installer.
- `downloads/ExcelsisHelper-1.3.1-public.1-Setup.exe.blockmap` - installer update blockmap.
- `downloads/ExcelsisHelper-1.3.1-public.1-source.zip` - exact corresponding Helper source.
- `downloads/ExcelsisHelper-1.3.1-public.1-SHA256SUMS.txt` - Helper artifact checksums.
...
- `helper/` - exact Excelsis Helper 1.3.1-public.1 source and build documentation.
