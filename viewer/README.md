...
The native x64 Explorer thumbnail provider has a separate, tighter 32 MiB input ceiling, with limits of 250,000 code/value pairs, 30,000 entities, and 200,000 rendered points. It processes files read-only inside Windows' thumbnail host, does not launch Electron, and falls back to the normal icon for unsupported binary DXF files. See [shell/thumbnail-provider/README.md](shell/thumbnail-provider/README.md).
